                ...
                <div className={`p-6 text-medium w-full h-full ${Tab === "company"? "" : "hidden"}`}>
                    ...
                    <div className="mt-5 flex space-x-3">
                        <div className="w-1/3">
                            <div className="relative z-0 w-full group">
                                <input type="text" name="name" className="input-basic peer" placeholder=" "  />
                    ...
                    <div className="mt-5 flex space-x-3">
                        <div className="w-4/12">
                            <div className="relative z-0 w-full group">
                                <input type="text" name="contact_address" className="input-basic peer" placeholder=" "  />
                                <label className="label-basic">Dirreccion</label>
                            </div>
                        </div>
                        <div className="w-3/12">
                            <div className="relative z-0 w-full group">
                                <input type="text" name="contact_city" className="input-basic peer" placeholder=" " />
                        ...
                        <div className="w-3/12">
                            <div className="relative z-0 w-full group">
                                <input type="text" name="contact_state" className="input-basic peer" placeholder=" " />
                                <label className="label-basic">Estado</label>
                            </div>
                        </div>
                        <div className="w-2/12">
                            <div className="relative z-0 w-full group">
                                <input type="text" name="contact_zip" className="input-basic peer" placeholder=" " />
                    ...
                    <div className="mt-5 flex items-center space-x-3">
                        ...
                        <div className="w-1/2">
                            <div className="relative z-0 w-full mb-5 group">
                                <input type="date" name="association_date" className="input-basic peer" placeholder=" "  />
