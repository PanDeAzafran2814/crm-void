...
import { UpdateLead } from "@/app/lib/leads/actions";
import { Tables } from "@/app/lib/defintions/database";

export default function LeadsFormEdit({ leadData }: { leadData: Tables<"leads">}){

    const [Tab, SetTab] = useState("company");
    const initialState = { message: null, status: "none", errors: {} }
    const UpdateLeadById = UpdateLead.bind(null, leadData.id)
    const [state, dispatch] = useFormState(UpdateLeadById, initialState)
            ...
            <form className="w-5/6 h-[90%] bg-gray-100 rounded-lg" onSubmit={handleSubmit}>
                <div className={`p-6 text-medium w-full h-full ${Tab === "company"? "" : "hidden"}`}>
                    ...
                    <div className="mt-5 flex space-x-3">
                        <div className="w-1/3">
                            <div className="relative z-0 w-full group">
                                <input defaultValue={leadData.contact_name || ""} type="text" name="contact_name" className="input-basic peer" placeholder=" "  />
                        ...
                        <div className="w-1/3">
                            <div className="relative z-0 w-full group">
                                <input defaultValue={leadData.contact_email || ""} type="text" name="contact_email" className="input-basic peer" placeholder=" " />
                                <label className="label-basic">Correo Del Contacto</label>
                            </div>
                        </div>
                        <div className="w-1/3">
                            <div className="relative z-0 w-full group">
                                <input defaultValue={leadData.contact_phone || ""} type="text" name="contact_phone" className="input-basic peer" placeholder=" " />
                    ...
                    <div className="mt-5 flex space-x-3">
                        <div className="w-1/2">
                            <div className="relative z-0 w-full group">
                                <input defaultValue={leadData.company_name || ""} type="text" name="contact_company" className="input-basic peer" placeholder=" "  />
                                <label className="label-basic">Nombre De La Empresa</label>
                            </div>
                        </div>
                        <div className="w-1/2">
                            <div className="relative z-0 w-full group">
                                <input defaultValue={leadData.contact_position || ""} type="text" name="contact_position" className="input-basic peer" placeholder=" "  />
                ...
                <div className="mt-5 flex space-x-3">
                    <div className="w-full">
                        ...
                        <select defaultValue={leadData.source || "default"} id="source" name="source" className="select-basic">
